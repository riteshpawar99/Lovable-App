  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "riteshpawar754@gmail.com",
      href: "mailto:riteshpawar754@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 9359639570",
      href: "tel:+919359639570"
    },
    {
      icon: MapPin,
      label: "Location",
          ...
          >
              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  <motion.div
                    ...
                    className="flex items-center gap-4 p-4 card-gradient card-hover rounded-xl"
                  >
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Currently seeking full-stack development opportunities and exciting projects to collaborate on.
              </p>
            </motion.div>
          </motion.div>
        </div>
