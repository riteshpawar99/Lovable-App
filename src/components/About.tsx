...
const About = () => {
  const stats = [
    { icon: GraduationCap, label: "CGPA", value: "8.10", desc: "B.Tech Computer Engineering" },
    { icon: Award, label: "Certifications", value: "4+", desc: "AWS, Oracle, Fortinet" },
    { icon: Target, label: "Projects", value: "10+", desc: "Full Stack Applications" },
    { icon: Code2, label: "Experience", value: "2+", desc: "Years in Development" },
  ];
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Currently pursuing Bachelor of Technology in Computer Engineering at Sandip University, Nashik, 
                  I've maintained a strong academic record with 8.10 CGPA while gaining practical experience 
