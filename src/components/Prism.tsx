...
interface PrismProps {
  ...
  height?: number;
  /** Base width of the prism */
  baseWidth?: number;
  /** Animation type: 'rotate' | 'hover' | '3drotate' | 'static' */
  animationType?: 'rotate' | 'hover' | '3drotate' | 'static';
  /** Glow intensity */
  glow?: number;
  /** Position offset */
  ...
  /** Overall scale */
  scale?: number;
  /** Hue shift for color adjustment */
  hueShift?: number;
  /** Color frequency */
  colorFrequency?: number;
  /** Hover interaction strength */
  hoverStrength?: number;
  /** Animation inertia/smoothness */
  inertia?: number;
  /** Bloom effect intensity */
  bloom?: number;
  /** Suspend animation when off-screen */
  suspendWhenOffscreen?: boolean;
  /** Time scale for animations */
  timeScale?: number;
}

/**
 * Prism 3D Animation Component
 * 
 * A WebGL-based 3D prism animation that can be customized with various props.
 * Perfect for hero sections, backgrounds, or decorative elements.
 * 
 * @example
 * <Prism 
